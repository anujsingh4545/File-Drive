...
const SideNav = ({setnavHead}: any) => {
  ...
  return (
    <>
      ...
      <section className={` z-20 fixed mt-[250px]  rounded-s-sm pr-5 py-3 pl-2 rounded-full flex items-center justify-center cursor-pointer  bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-white ${!showpanel ? "left-0" : "left-[-500px] "} ease-in-out duration-300 `} onClick={() => setShowPanel(true)}>
